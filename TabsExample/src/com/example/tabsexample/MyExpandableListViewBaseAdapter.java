 ...
 * @author optimus158
 *
 *	Adapter class for the Expandable ListView showing the Tweets
 *
 */
public class MyExpandableListViewBaseAdapter extends BaseExpandableListAdapter {

	private List<String> list;
	private HashMap<String, List<String>> map;
	private Context context;
	public MyExpandableListViewBaseAdapter(Context context, List<String> list, HashMap<String, List<String>> map) {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		convertView = inflator.inflate(R.layout.e_list_view_layout_child, null);
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		LayoutInflater inflator = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		convertView = inflator.inflate(R.layout.e_list_view_layout_parent, null);
